...
public class InfoMp3 extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InfoMp3.class.getName());

    private int idMp3;

    public InfoMp3(int idMp3) {
        this.idMp3 = idMp3;
        initComponents();
    ...
    private void btnCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCarritoActionPerformed
        ...
        carrito.setTipo("mp3");
        carrito.setId_producto(idMp3);
        carrito.setPrecio_unitario(m.getPrecio());
        carrito.setCantidad(1);
        carrito.setFecha_agregado(new java.sql.Date(System.currentTimeMillis()));
        carrito.setEstado("activo");  

        // Agregar el id_vendedor capturado desde el mp3
        carrito.setId_vendedor(m.getId_vendedor());  
        ...
        if (agregado) {
            JOptionPane.showMessageDialog(this, "Mp3 agregado al carrito exitosamente.");
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Error al agregar el mp3 al carrito.");
        }
    }//GEN-LAST:event_btnCarritoActionPerformed

    private void cargarCancionesDelMp3(int idMp3) {
        Cancion_disco_mp3DAO cavD = new Cancion_disco_mp3DAO();
        List<Cancion> lista = cavD.listarCancionesPorMp3(idMp3);
    ...
    private void cargarDatosMp3() {
        ...
        lbNombre.setText(m.getNombre());
        lbGenero.setText(m.getGenero());
